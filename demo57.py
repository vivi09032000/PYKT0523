...
from sklearn.model_selection import  train_test_split#判斷是否為好的model
import keras
...
feature_train, feature_test,label_train,label_test = train_test_split(inputList,resultList,test_size=0.25,stratify=resultList)
